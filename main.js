...
if (logoutLink) {
  ...
  if (localStorage.getItem("loggedIn")) {
    logoutLink.querySelector("p").textContent = "تسجيل الخروج";
    logoutLink.querySelector("i").className = "fas fa-sign-out-alt";
    logoutLink.href = "#";
    logoutLink.classList.add("logout-active"); // إضافة اللون الأحمر
    ...
    logoutLink.querySelector("p").textContent = "تسجيل الدخول";
    logoutLink.querySelector("i").className = "fas fa-sign-in-alt";
    logoutLink.href = "login.html";
    logoutLink.classList.remove("logout-active");
  }
}
